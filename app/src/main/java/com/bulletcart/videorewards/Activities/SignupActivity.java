...
public class SignupActivity extends ActivityBase implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                    ...
                    public void onComplete(@NonNull Task<InstanceIdResult> task) {
                        if (task.isSuccessful())
                            m_strToken = task.getResult().getToken();
                    }
                });
        ...
        signupJoinBtn = findViewById(R.id.signupJoinBtn);
            ...
            public void onClick(View v) {
                ...
                if (verifyRegForm()) {
                    ...
                    if (App.getInstance().isConnected()) {
                        ...
                        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, GlobalConstants.METHOD_ACCOUNT_SIGNUP, null,
                                new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {

                                        if(GlobalConstants.DEBUG_MODE){Log.e("Profile", "Malformed JSON: \"" + response.toString() + "\"");}
                                        ...
                                        if (App.getInstance().authorize(response)) {
                                            ...
                                            switch (App.getInstance().getErrorCode()) {
                                                ...
                                                case GlobalConstants.ERROR_LOGIN_TAKEN : {

                                                    signupUsername.setError(getString(R.string.error_login_taken));
                                                    break;
                                                }

                                                case GlobalConstants.ERROR_EMAIL_TAKEN : {
                                                ...
                                                case GlobalConstants.ERROR_IP_TAKEN : {
                                                ...
                                                default: {
                                                    ...
                                                    if(GlobalConstants.DEBUG_MODE){Log.e("Profile", "Could not parse malformed JSON: \"" + response.toString() + "\"");}
...
//                                if(GlobalConstants.DEBUG_MODE){Log.e("Profile", "Malformed JSON: \"" + error.getMessage() + "\"");}
                            ...
                            protected Map<String, String> getParams() {
                                ...
                                params.put("firebase_token", m_strToken);
                                return params;
                            }
                        };
