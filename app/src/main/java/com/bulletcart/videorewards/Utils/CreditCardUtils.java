...
public class CreditCardUtils {
    ...
    public static boolean isValid(String cardNumber) {
        return !TextUtils.isEmpty(cardNumber)
                ...
                || getCardType(cardNumber) == MASTERCARD && cardNumber.length() == 16
                || getCardType(cardNumber) == AMEX && cardNumber.length() == 15
                || getCardType(cardNumber) == DISCOVER && cardNumber.length() == 16);
    }
